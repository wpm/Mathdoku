...
test.describe('provisional cage', () => {
  test('Shift+Arrow on uncovered cell draws provisional outline', async ({
    page,
  }) => {
    await setup(page);
  ...
  test('provisional cage has distinct color from selection', async ({
    page,
  }) => {
    await setup(page);
    await page.keyboard.press(SHIFT_ARROW_RIGHT);
  ...
  test('Shift+Arrow when target cell is covered does nothing', async ({
    page,
  }) => {
    await setup(page, PUZZLE_WITH_CAGE);
  ...
  test('multiple Shift+Arrow presses grow the provisional cage', async ({
    page,
  }) => {
    await setup(page);
    await page.keyboard.press(SHIFT_ARROW_RIGHT);
  ...
  test('Escape in operation selector deletes the provisional cage', async ({
    page,
  }) => {
    await setup(page);
  ...
  test('Escape in provisional cage without selector open deletes the provisional cage', async ({
    page,
  }) => {
    await setup(page);
  ...
  test('regular Arrow moves cursor without clearing provisional cage', async ({
    page,
  }) => {
    await setup(page);
  ...
  test('Shift+Arrow from disconnected cell parks old cage and starts new one', async ({
    page,
  }) => {
    await setup(page);
  ...
  test('Enter on uncovered cell with no provisional creates singleton cage', async ({
    page,
  }) => {
    await setup(page);
  ...
  test('Enter on covered cell with no provisional does nothing', async ({
    page,
  }) => {
    await setup(page, PUZZLE_WITH_CAGE);
    // (0,0) is covered.
  ...
  test('Enter then operator commits provisional cage and returns to active cell', async ({
    page,
  }) => {
    await setup(page);
  ...
  test('Escape from operation selector deletes the provisional cage', async ({
    page,
  }) => {
    await setup(page);
    await page.keyboard.press(SHIFT_ARROW_RIGHT); // draw {(0,0),(0,1)}
  ...
  test('ArrowRight moves highlight forward in operation selector', async ({
    page,
  }) => {
    await setup(page);
    await page.keyboard.press(SHIFT_ARROW_RIGHT); // draw {(0,0),(0,1)}
  ...
  test('ArrowLeft moves highlight backward in operation selector', async ({
    page,
  }) => {
    await setup(page);
    await page.keyboard.press(SHIFT_ARROW_RIGHT);
  ...
  test('Enter commits highlighted tab in operation selector', async ({
    page,
  }) => {
    await setup(page);
    await page.keyboard.press(SHIFT_ARROW_RIGHT);
  ...
  test('3-cell provisional shows only Add and Multiply in operation selector', async ({
    page,
  }) => {
    await setup(page);
    await page.keyboard.press(SHIFT_ARROW_RIGHT); // draw {(0,0),(0,1)}
...
test.describe('Escape demotes committed cage', () => {
  test('Escape on a committed cage demotes it to provisional', async ({
    page,
  }) => {
    await setup(page);
  ...
  test('Escape on a committed multi-cell cage opens operation selector', async ({
    page,
  }) => {
    await setup(page);
    await page.keyboard.press(SHIFT_ARROW_RIGHT); // draw {(0,0),(0,1)}
...
test.describe('Delete removes cages', () => {
  test('Delete on a committed cage deletes it outright (no demotion)', async ({
    page,
  }) => {
    await setup(page);
    await page.keyboard.press(ENTER); // commit singleton at (0,0)
  ...
  test('Delete on a committed multi-cell cage deletes it without opening selector', async ({
    page,
  }) => {
    await setup(page);
    await page.keyboard.press(SHIFT_ARROW_RIGHT); // draw {(0,0),(0,1)}
  ...
  test('Backspace behaves the same as Delete on a committed cage', async ({
    page,
  }) => {
    await setup(page);
    await page.keyboard.press(ENTER); // commit singleton at (0,0)
